...
function BindGrid() {
    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            v = "/Home/UserPermission?mainid=1&UserId=";
                ...
                n.length &&
                    ...
                    
                    {
                        ...
                        render: function (e, t, a, s) {
                            a = a.UM_Id;
                            return (
                                '<div class="d-flex align-items-center"><a href="' + v + a + '" class="text-body"  target="_blank"><i class="ti ti-eye ti-sm me-2"></i></a></div></div>'
                            );
                        },
                    },
                        ],
