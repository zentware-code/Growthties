...
!(function () {
    ...
    if ($('#hdnFyFilterId').val() > 0) {
        // Enable elements with the class .disAble
        $('.disAble').prop('disabled', false);
    } else {
        // Disable elements with the class .disAble
        ...
        success: function (data) {
            if (data != null && data != undefined && data.IsSuccess == true) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        //$('#exLargeModal').modal('hide');
                        window.location.href = '/Stakeholder/ProjectBudgetDashboard?Id=' + Id + '&ENR_Id=' + $('#hdnProjctENrId').val();
                    }
...
function fundWiseBudgetDistributionDetailsSMME(pbdId) {
 ...
 $('#ddlTaskActivitySMME').on('change', function () {
                ...
                fundWiseBudgetActivityDetailsForSMME(Id, $('#ddlTaskActivitySMME').val(), $('#ddlBudgetDistSMME').val())
                ...
                $('#ddlTaskSMME').on('change', function () {
                    ...
                    fundWiseBudgetTaskDetails(Id, $('#ddlTaskActivitySMME').val(), $('#ddlTaskSMME').val());
                    retriveSMMEBudgetDetails(Id, $('#ddlTaskActivitySMME').val(), $('#ddlTaskSMME').val(), $('#ddlBudgetDistSMME').val());
                });
