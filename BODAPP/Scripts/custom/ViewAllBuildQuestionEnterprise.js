                ...
                columnDefs: [
                  
                    {
                        ...
                        render: function (data,type,row) {
                            return '<div class="d-flex align-items-sm-center justify-content-sm-center"><a class="btn btn-sm btn-icon btnEdit" href="/Assessment/QuestionBuilding?Mode=E&Id='+row.BA_QuestionTypeId+'&BAId='+row.BA_Id+'"  ><i class="ti ti-edit"></i></a><a class="btn btn-sm btn-icon btnEdit" href="/Assessment/ViewAssessmentForEnterprise?Mode=E&Id='+row.BA_QuestionTypeId+'&BAId='+row.BA_Id+'"  ><i class="ti ti-eye mx-2 ti-sm"></i></a></div>';
                        },
                    },
                ],
                order: [0, "desc"],
