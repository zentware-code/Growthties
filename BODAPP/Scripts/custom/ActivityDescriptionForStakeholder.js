    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, v) {
                ...
                var line = '';
                pl = '/Stakeholder/ProjectDetailsNew?Id=' + v.PD_Id;
                al = '/Stakeholder/CreateActivity?M=E' + '&Id=' + v.PD_Id + '&CAId=' + v.CA_Id;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (count > 0 && count == 1) {
                ...
                //$('#divSmmE').append(SMMLogoList + '<div class="avatar me-2"><span id="clkLogo" class="avatar-initial rounded-circle pull-up" data-bs-toggle="tooltip" data-bs-target="#shareProjectClkLogo" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-placement="bottom" title="3 more">+3</span></div>');
                ...
                //$('#shareProjectClkLogo').modal('show');
            }
            else {
