...
function BindGrid() {
    ...
    var _data = JSON.stringify({
        global: {
            TransactionType: 'SelectActiveEnterprise',
            Param: 'ENR_Id',
        ...
        success: function (data, status) {
            ...
            i.length && (i = i).wrap('<div class="position-relative"></div>').select2({ placeholder: "Select Country", dropdownParent: i.parent() }),
                n.length &&
                    (e = n.DataTable({
                        data:data,
                        columns: [{ data: "" }, { data: "ENR_CompanyName" }, { data: "ETM_EnterpriseType" }, { data: "ENR_RegNumber" }, { data: "" }, { data: "ENR_PrimaryContactNo" }, { data: "action" }],                      
                        columnDefs: [
                    {
                        className: "control",
                        searchable: !1,
                    ...
                    },
                    {
                        ...
                        render: function (e, t, a, s) {
                            var r = a.TotalSMME;
                            return (
                                '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="ti ti-users ti-sm me-2 text-primary"></i>'+r+'</div></div>'
                            );
                        },
                    },
                    {
                        ...
                        render: function (e, t, a, s) {
                            a = a.ENR_Id;
                            return (
                                '<div class="d-flex align-items-center"><a  target="_blank" href="' + y + a + '" class="text-body"><i class="ti ti-user-plus ti-sm"></i></a></div></div>'
                            );
                        },
                    },
                        ],
