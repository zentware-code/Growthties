...
function SaveRecords() {
    ...
    $.ajax({
        type: "POST",
        url: "/ScriptJson/UpdateUserProfileSettings",
        data: _data,
                ...
                //if (retId > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            GetDataForAmdinUserProfile(retId)
                        }
                    });
...
function GetDataForAmdinUserProfile(id) {
    ...
    var _data = JSON.stringify({
        global: {
            TransactionType: 'SelectUserProfileData',
            param1: 'UM_Id',
