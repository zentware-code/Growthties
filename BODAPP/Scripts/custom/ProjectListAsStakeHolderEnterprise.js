...
function fnProjectForEnterprise() {
    ...
    var _data = JSON.stringify({
        global: {
            TransactionType: 'SelectAllStakeholderProjectForEnterprise',
