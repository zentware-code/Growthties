                ...
                columnDefs: [
                    {
                        ...
                        render: function (e, t, a, s) {
                            var p = a.PD_Id ;
                            return (
                                                           '<div class="d-flex justify-content-start align-items-center user-name"><div class="d-flex flex-column"><a href="/Project/ProjectDetailsNew?Id=' + p + '"><span class=" fw-normal text-' +
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return '<div class="d-flex align-items-sm-center"><a href="/Enterprise/EnterpriseProfieView_Profiles?Id=' + row.PD_Enterpriseid + '">' + row.ENR_CompanyName + '</a></div>';
                    ...
                    },
                    {
                        targets: 3,
                        title: "Actions",
                        className: "all", // Force this column to never hide in responsive mode
                        orderable: false,
                        searchable: false,
                        render: function (data, type, row) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, v) {
                ...
                $("#ulSmmeList").append("<li class='d-flex flex-wrap mb-3'>" + logo +
                    "<div class='form-check form-switch'>" +
                    "<input class='float-end form-check-input' type='checkbox' " + v.checked +
                    " id='chkId_" + index + "' onclick='AssignProject(" + index + ", " + v.SMME_Id + ", \"" + v.SMME_CompanyName + "\", \"" + v.SMME_PrimaryContactEmail + "\")'>" +
                    "</div>" +
                "</li>");
