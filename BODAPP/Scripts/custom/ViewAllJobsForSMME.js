        ...
        success: function (data, status) {
            ...
            i.length && (i = i).wrap('<div class="position-relative"></div>').select2({ placeholder: "Select Country", dropdownParent: i.parent() }),
                n.length &&
                    (e = n.DataTable({
                        data:data,
                        columns: [{ data: "" }, { data: "JD_JobName" }, { data: "JD_VistType" }, { data: "CD_Name" }, { data: "action" }],
                        columnDefs: [
                    {
                        className: "control",
                        searchable: !1,
                    ...
                    },
                    {
                        ...
                        render: function (e, t, a, s) {
                            ...
                            return (
                                '<div class="d-flex align-items-center"><a href="' + v +  a.JD_Id + '" class="text-body"  target="_blank"><i class="ti ti-edit ti-sm me-2"></i></a><button class="btn btn-sm btn-icon me-2"  onclick="chkForAssignType(' +  a.JD_Id + ',\'' + a.AssignType + '\')" data-bs-dismiss="modal"><i class="ti ti-user-plus ti-sm me-2"></i></button></div></div>'
                            );
                        },
                    },
                        ],
...
function chkForAssignType(JobId, Type) {
    if (Type == "Team") {
...
function AssignJobs(index, UmId, TeamId) {
    var Transaction="";
    if ($('#chkId_' + index).is(':checked')) {

        Transaction = "AssignJobToSmmeUser";
    } else {

        Transaction="UnAssignJobToSmmeUser";
    }
    ...
    var _data = JSON.stringify({
        ...
        type: "POST",
        url: '/ScriptJson/AssignJobToSMMEUser',
        data: _data,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
