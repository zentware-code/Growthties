            ...
            if (data != null && data != undefined && data.IsSuccess == true) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '/Project/TaskList?Id=' + $('#hdnProjectId').val() + '&CAId=' + $('#hdnActivityId').val() + '';
                    }
                });
            } else {
                Swal.fire({
...
//*************retrive currency************
    ...
    function SendMail(id) {
        ...
        var action = 'createnewtask';

        var _data = JSON.stringify({
            emailcontent: {
                Id: parseInt(id),
                PD_Id: $('#hdnProjectId').val(),
                EventName: $('#txtTaskName').val(),
