                ...
                n.length &&
                    ...
                    
                    {
                        ...
                        render: function  (data,type,row) {
                            ...
                            b=row.UM_MainId;
                            return (
                                '<div class="d-flex align-items-center"><a  href="/Home/UserPermissionForEnterpriseUser?UserId='+a+'&mainid='+b+'" class="text-body"  target="_blank"><i class="ti ti-eye ti-sm me-2"></i></a></div></div>'
                            );
                        },
                    },
                        ],
