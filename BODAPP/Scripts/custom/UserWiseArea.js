...
function BrancheWiseArea() {
    var _data = JSON.stringify({
        global: {
            TransactionType: 'SelectUserWiseBrancheAreaList',
            param1: 'UM_Id',
