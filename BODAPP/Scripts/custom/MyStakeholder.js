    ...
    if($('#hdnStakeHolderType').val()=='SU')
    {
        var _data = JSON.stringify({
            global: {
                ...
                TransactionType: "SelectMyStakeholdersForUser",
                param1: 'ENR_Id',
        ...
        var _data = JSON.stringify({
            global: {
                // TransactionType: "SelectAssignedStakeholders",
                TransactionType: "SelectMyStakeholders",
                param1: 'ENR_Id',
                param1Value: parseInt($('#hdnEntrId').val()),
                StoreProcedure: "EnterpriseRegistration_USP"
            }
                                   ...
                                   '<div class="card">' +
                                       '<div class="card-body text-center">' +
                                           ...
                                           '<div class="mx-auto my-3">' +
                                               ...
                                               '<img src="' +
                                                  ((stakeholder.ENR_CompanyLogo === 'NO' ? defaultLogo : stakeholder.ENR_CompanyLogo).replace(/^~/, '')) +
                                                '" alt="Avatar Image" class="" style="width:150px; height:auto; display:block; margin:auto"/>' +
                                           '</div>' +
                                           ...
                                           '<div class="d-flex align-items-center justify-content-center">' +
                                               '<a href="/Stakeholder/StakeHolderDashboard?Id='+ stakeholder.ENR_Id +'" target="_blank" class="btn btn-primary d-flex align-items-center me-3"  onclick="getValue(121)"><i class="ti-xs me-1 ti ti-user-check me-1"></i>View</a>' +
                                           '</div>' +
                                       '</div>' +
                                   '</div>' +
                               '</div>';
