...
function BindGrid() {
    ...
    var _data = JSON.stringify({
        global: {
            ...
            TransactionType: 'SelectListForStakeholder',
                        ...
                        buttons: [
                            {
                                ...
                                action: function () {
                                    window.location.href = "/Stakeholder/AddBranch";
                                },
                            },
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, v) {
                ...
                var index = i + 1;
                $("#ulSMMEList").append("<li class='d-flex flex-wrap mb-3'><div class='d-flex flex-grow-1 justify-content-between'><div class=me-2><h6 class=mb-0>" + v.SMME_CompanyName + "</h6><p class='mb-0 text-muted'>Email: " + v.SMME_PrimaryContactEmail + "</div><div class='d-flex align-items-center col-3 justify-content-end'><div class='form-check form-switch'><input class='float-end form-check-input chkinput chkinputsmme' type='checkbox' " + v.Ischecked + " id='chkIdSMME_" + index + "' onclick='AssignSMMEToBranch(" + index + "," + v.SMME_Id + "," + id + ")'></div></div></div>");
...
function AssignSMMEToBranch(index, smmeId,BD_Id) {
    var Transaction = "";
