    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data != undefined && data.IsSuccess == true) {
                ...
                //{
                //    window.location.href = '/Stakeholder/CreateActivityList?Id=' + parseInt(ProjId) + ''
                //}
                //else {
                //    window.location.href = '/Stakeholder/CreateActivityList';
...
function fnProjectForAdmin(Id,M) {
    ...
    $.ajax({
        ...
        dataType: "json",
        beforeSend: function () {
            LoaderStart("#snglProjectDiv");
        },
        complete: function () {
            LoaderEnd("#snglProjectDiv");
        },
        success: function (data) {
            data = JSON.parse(data);
            var count = data.length;
