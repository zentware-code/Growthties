    ...
    $.ajax({
        ...
        success: function (data) {
          //  fnCustForEnterprise(data["ENR_Id"]);
            ...
            $('#spnName').text(data["ENR_PrimaryContactName"]);
            $('#spnBusinessType').text(data["ETM_EnterpriseType"]);
            $('#spnSector').text(data["SM_SectorName"]);
            $('#spnContactNo').text(data["ENR_PrimaryContactNo"]);
            $('#spnEmail').text(data["ENR_PrimaryContactEmail"]);

            $('#spnEmp').text(data["TotalUser"]);
            $('#spnSMME').text(data["TotalSMME"]);
