...
function BindGrid() {
   // $("#datatable-example").destroy();
    var _data = JSON.stringify({
        global: {
            TransactionType: 'SelectAllEnterpriseStakeHolderUser',  //SelectAllEnterpriseUser
            param1: 'ENR_Id',
                            ...
                            return (
                                ...
                                (o
                                    ...
                                    : '<span class="avatar-initial rounded-circle bg-label-' +
                                      ...
                                      "</span>") +
                                '</div></div><div class="d-flex flex-column"><span class="fw-medium">' +
                                n +
