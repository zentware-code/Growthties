                ...
                columnDefs: [
                  
                    {
                        ...
                        render: function (data,type,row) {
                            return '<div class="d-flex align-items-sm-center justify-content-sm-center"><a class="btn btn-sm btn-icon btnEdit" href="/Job/TeamBuilding?Id=' + row.BT_Id + '" ><i class="ti ti-edit"></i></a></div>';
                        },
                    },
                ],
                order: [0, "desc"],
