    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            e.length &&
                (e.DataTable({
                    data:data,
                    columns: [{ data: "" }, { data: "PD_ProjectName" }, { data: "ENR_CompanyName" }, { data: "" }, { data: "Status" }, { data: "" }],
                    columnDefs: [
                        {
                            className: "control",
                            searchable: !1,
                                ...
                                return (
                                    ...
                                    (s
                                        ...
                                        : '<span class="avatar-initial rounded-circle bg-label-' +
                                          ...
                                          '">' +
                                          (s = (((s = (d = t.PD_ProjectName).match(/\b\w/g) || []).shift() || "") + (s.pop() || "")).toUpperCase()) +
                                          "</span>") +
                        ...
                        },
                        {
                            ...
                            orderable: !1,
                            render: function (e, a, t, r) {
                                return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div></div></div>';
                            },
                        },
                    ],
                    order: [[2, "desc"]],
                ...
                $("div.head-label").html('<h5 class="card-title mb-0">Projects List</h5>')),
                setTimeout(() => {
