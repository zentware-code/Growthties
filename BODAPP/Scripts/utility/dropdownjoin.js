 ...
 * Dependencies: jQuery, showMessage()
 */

// ===============================
// bootstrap
// ===============================
const DropdownBinderJoin = {
    /** payload object sent to server */
    DDLData: {},
    /** jQuery dropdown element e.g. $('#ddlCity') */
    DDLElem: {},

    /** Fire the population request for JOIN source */
    Execute() {
 ...
 * (Duplicated intentionally to keep files independent and names unchanged.)
...
// actions (demo)
// ===============================
/** Example demo binder (points to non-join endpoint by design) */
